...
namespace ConfigureAwaitRefactoringDotNext
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(ConfigureAwaitRefactoringDotNextCodeRefactoringProvider)), Shared]
    internal class ConfigureAwaitRefactoringDotNextCodeRefactoringProvider : CodeRefactoringProvider
    {
